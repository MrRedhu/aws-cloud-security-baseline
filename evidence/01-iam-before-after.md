...
## CHANGE
Developer permissions were replaced with a least-privilege policy:
- Removed wildcard admin-like access
- Added scoped read/describe permissions needed for security visibility
- Added explicit deny for IAM / org / account write actions to prevent privilege escalation
